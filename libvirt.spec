...
%setup -q -n libvirt-11.3.0
cd %{_builddir}/libvirt-11.3.0
%patch -P 1 -p1
%patch -P 2 -p1
%patch -P 3 -p1
pushd ..
cp -a libvirt-11.3.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1746195487
...
/V3/usr/lib64/libvirt-admin.so.0.11003.0
/V3/usr/lib64/libvirt-lxc.so.0.11003.0
/V3/usr/lib64/libvirt-qemu.so.0.11003.0
/V3/usr/lib64/libvirt.so.0.11003.0
...
/usr/lib64/libvirt-admin.so.0.11003.0
/usr/lib64/libvirt-lxc.so.0
/usr/lib64/libvirt-lxc.so.0.11003.0
/usr/lib64/libvirt-qemu.so.0
/usr/lib64/libvirt-qemu.so.0.11003.0
/usr/lib64/libvirt.so.0
/usr/lib64/libvirt.so.0.11003.0

...
Version  : 10.2.0
Release  : 164
URL      : https://libvirt.org/sources/libvirt-10.2.0.tar.xz
Source0  : https://libvirt.org/sources/libvirt-10.2.0.tar.xz
Source1  : https://libvirt.org/sources/libvirt-10.2.0.tar.xz.asc
...
%prep
%setup -q -n libvirt-10.2.0
cd %{_builddir}/libvirt-10.2.0
%patch -P 1 -p1
%patch -P 2 -p1
%patch -P 3 -p1
pushd ..
cp -a libvirt-10.2.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712072550
...
/V3/usr/lib64/libvirt-admin.so.0.10002.0
/V3/usr/lib64/libvirt-lxc.so.0.10002.0
/V3/usr/lib64/libvirt-qemu.so.0.10002.0
/V3/usr/lib64/libvirt.so.0.10002.0
...
/usr/lib64/libvirt-admin.so.0.10002.0
/usr/lib64/libvirt-lxc.so.0
/usr/lib64/libvirt-lxc.so.0.10002.0
/usr/lib64/libvirt-qemu.so.0
/usr/lib64/libvirt-qemu.so.0.10002.0
/usr/lib64/libvirt.so.0
/usr/lib64/libvirt.so.0.10002.0

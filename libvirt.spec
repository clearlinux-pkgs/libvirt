...
Version  : 10.1.0
Release  : 163
URL      : https://libvirt.org/sources/libvirt-10.1.0.tar.xz
Source0  : https://libvirt.org/sources/libvirt-10.1.0.tar.xz
Source1  : https://libvirt.org/sources/libvirt-10.1.0.tar.xz.asc
...
%prep
%setup -q -n libvirt-10.1.0
cd %{_builddir}/libvirt-10.1.0
%patch -P 1 -p1
%patch -P 2 -p1
%patch -P 3 -p1
pushd ..
cp -a libvirt-10.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709318955
...
/V3/usr/lib64/libvirt-admin.so.0.10001.0
/V3/usr/lib64/libvirt-lxc.so.0.10001.0
/V3/usr/lib64/libvirt-qemu.so.0.10001.0
/V3/usr/lib64/libvirt.so.0.10001.0
...
/usr/lib64/libvirt-admin.so.0.10001.0
/usr/lib64/libvirt-lxc.so.0
/usr/lib64/libvirt-lxc.so.0.10001.0
/usr/lib64/libvirt-qemu.so.0
/usr/lib64/libvirt-qemu.so.0.10001.0
/usr/lib64/libvirt.so.0
/usr/lib64/libvirt.so.0.10001.0

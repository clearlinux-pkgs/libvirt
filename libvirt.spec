...
Source0  : https://libvirt.org/sources/libvirt-8.5.0.tar.xz
Source1  : https://libvirt.org/sources/libvirt-8.5.0.tar.xz.asc
...
%prep
%setup -q -n libvirt-8.5.0
cd %{_builddir}/libvirt-8.5.0
%patch1 -p1
%patch2 -p1
%patch3 -p1
%patch4 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656696836
...
cp %{_builddir}/libvirt-8.5.0/COPYING %{buildroot}/usr/share/package-licenses/libvirt/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/libvirt-8.5.0/COPYING.LESSER %{buildroot}/usr/share/package-licenses/libvirt/3704f4680301a60004b20f94e0b5b8c7ff1484a9
cp %{_builddir}/libvirt-8.5.0/docs/fonts/LICENSE.rst %{buildroot}/usr/share/package-licenses/libvirt/f4e4f4ac8fa716d051ac27a5415491544c8f456e
cp %{_builddir}/libvirt-8.5.0/src/keycodemapdb/LICENSE.BSD %{buildroot}/usr/share/package-licenses/libvirt/ea5b412c09f3b29ba1d81a61b878c5c16ffe69d8
cp %{_builddir}/libvirt-8.5.0/src/keycodemapdb/LICENSE.GPL2 %{buildroot}/usr/share/package-licenses/libvirt/06877624ea5c77efe3b7e39b0f909eda6e25a4ec
...
/usr/lib64/libvirt-admin.so.0.8005.0
/usr/lib64/libvirt-lxc.so.0
/usr/lib64/libvirt-lxc.so.0.8005.0
/usr/lib64/libvirt-qemu.so.0
/usr/lib64/libvirt-qemu.so.0.8005.0
/usr/lib64/libvirt.so.0
/usr/lib64/libvirt.so.0.8005.0

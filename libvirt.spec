...
Version  : 10.10.0
Release  : 173
URL      : https://libvirt.org/sources/libvirt-10.10.0.tar.xz
Source0  : https://libvirt.org/sources/libvirt-10.10.0.tar.xz
Source1  : https://libvirt.org/sources/libvirt-10.10.0.tar.xz.asc
...
%setup -q -n libvirt-10.10.0
cd %{_builddir}/libvirt-10.10.0
%patch -P 1 -p1
%patch -P 2 -p1
%patch -P 3 -p1
pushd ..
cp -a libvirt-10.10.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735085184
...
-Dudev=enabled  builddir
ninja -v -C builddir
GOAMD64=v3
CFLAGS="$CFLAGS -march=x86-64-v3 -Wl,-z,x86-64-v3 " CXXFLAGS="$CXXFLAGS -march=x86-64-v3 -Wl,-z,x86-64-v3 " LDFLAGS="$LDFLAGS -march=x86-64-v3 " meson --libdir=lib64 --prefix=/usr --buildtype=plain -Dapparmor=disabled \
-Dapparmor_profiles=disabled \
-Ddriver_esx=disabled \
-Ddriver_hyperv=disabled \
-Ddriver_interface=enabled \
...
/V3/usr/lib64/libvirt-admin.so.0.10010.0
/V3/usr/lib64/libvirt-lxc.so.0.10010.0
/V3/usr/lib64/libvirt-qemu.so.0.10010.0
/V3/usr/lib64/libvirt.so.0.10010.0
...
/usr/lib64/libvirt-admin.so.0.10010.0
/usr/lib64/libvirt-lxc.so.0
/usr/lib64/libvirt-lxc.so.0.10010.0
/usr/lib64/libvirt-qemu.so.0
/usr/lib64/libvirt-qemu.so.0.10010.0
/usr/lib64/libvirt.so.0
/usr/lib64/libvirt.so.0.10010.0
...
%files libexec
%defattr(-,root,root,-)
/V3/usr/libexec/libvirt-ssh-proxy
